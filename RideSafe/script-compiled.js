// script-compiled.js - Fixed Global Version (No Modules, Uses React.createElement)
(function() {
    ...
    // Week Date Picker (Functional Component)
    ...
    function App() {
        ...
        function handleBook() {
            ...
            db.ref('bookings/' + date + '/' + newKey).set(booking).then(function() {
                var templateParams = {
                    ...
                    miles: distance.miles,
                    price: '$' + price.price,
                    to_email: 'your-driver@example.com' // Update this
                };
                return emailjs.send('service_2ss0i0l', 'template_your_booking_template', templateParams); // Update template ID
            }).then(function() {
        ...
        var headerContent = [
            ...
            React.createElement('div', { key: 'title-div' },
                React.createElement('h1', { className: 'title', key: 'title' }, 'RideSafe'),
                React.createElement('p', { className: 'motto', key: 'motto' }, 'Safe, Reliable Airport Transfers')
            )
        ];
        ...
        if (price.price > 0) {
            formElements.push(React.createElement('div', { key: 'estimate', className: 'estimate' },
                React.createElement('p', null, 'Estimated: $', price.price, ' (', distance.miles, ' miles | Pickup ~', pickupDisplay, ')')
            ));
        }
        formElements.push(
